...
public:
    enum InstructionCode
    {
        ...
        CESAR_ROR,CESAR_ROL,CESAR_ASR,CESAR_ASL,CESAR_ADC,CESAR_SDC,
        /*cesar FLOW CONTROL*/
        CESAR_JMP,CESAR_BR,CESAR_BNE,CESAR_BEQ,CESAR_BPL,CESAR_BVC,CESAR_BVS,CESAR_BCC,CESAR_BCS,CESAR_BGE,
